  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      ...
      providers: [
        ...
        ChangeNotifierProvider(create: (context) => ProfileInfoViewModel(locator<UsersUseCase>(), locator<AuthUseCases>())),
        ChangeNotifierProvider(create: (context) => ProfileUpdateViewModel(locator<UsersUseCase>())),
